...
- [Libro de bioestadística](/Literatura/bioestadistica.pdf)
...
Además, el usuario podrá encontrar informacióna acerca de `R` y `R-Studio` en los siguientes recursos de información:
...
También encontrará guías de apoyo para desarrollar el trabajo con `R` y `R-Studio`.
